...
FILES=(data/subset_alignments_mafft_sparsecore/*.fasta)
...
projection="data/subset_alignments_proj_mafft_sparsecore/${FILENAME}"
...
mkdir -p tmp_mafft_sparsecore

echo ${FILENAME%.fasta} $sp $modeler $tc $col >> tmp_mafft_sparsecore/${SLURM_ARRAY_TASK_ID}.out
