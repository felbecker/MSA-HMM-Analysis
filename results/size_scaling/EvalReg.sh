...
FILES=(data/subset_alignments_reg/*.fasta)
...
projection="data/subset_alignments_proj_reg/${FILENAME}"
...
echo ${FILENAME%.fasta} $sp $modeler $tc $col >> tmp_reg/${SLURM_ARRAY_TASK_ID}.out
