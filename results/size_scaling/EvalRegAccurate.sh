...
#SBATCH --output=./reg_eval.%A_%a.log
#SBATCH -J reg_eval                                                                                                                                    
...
FILES=(data/subset_alignments_reg_accurate/*.fasta)
...
projection="data/subset_alignments_proj_reg_accurate/${FILENAME}"
...
mkdir -p tmp_reg_accurate

echo ${FILENAME%.fasta} $sp $modeler $tc $col >> tmp_reg_accurate/${SLURM_ARRAY_TASK_ID}.out
