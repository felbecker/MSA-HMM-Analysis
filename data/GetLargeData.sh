#!/bin/bash
wget https://bioinf.uni-greifswald.de/bioinf/learnMSA/learnMSA_large_data.tgz
tar xfvz learnMSA_large_data.tgz
chmod -w large/train/*.fasta
chmod -w large/refs/*.ref

#only version of this script below
#Warning:
